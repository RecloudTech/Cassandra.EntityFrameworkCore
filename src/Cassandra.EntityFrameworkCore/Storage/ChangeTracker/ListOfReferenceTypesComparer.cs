    ...
    where TElement : class
{
    ...
    private static readonly MethodInfo CompareMethod =
        typeof(ListOfReferenceTypesComparer<TConcreteCollection, TElement>).GetMethod(
            nameof(Compare), BindingFlags.Static | BindingFlags.NonPublic,
            [typeof(object), typeof(object), typeof(ValueComparer)])!;
    ...
    private static Expression<Func<object?, object?, bool>> CompareLambda(ValueComparer elementComparer)
    {
        ...
        return Expression.Lambda<Func<object?, object?, bool>>(
            Expression.Call(
                ...
                prm1,
                prm2,
                Expression.Constant(elementComparer)),
            prm1,
            prm2);
    }
    ...
    private static IList<TElement?> Snapshot(object source, ValueComparer elementComparer)
    {
        ...
        else
        {
            ...
            foreach (var e in sourceList) snapshot.Add(e == null ? null : (TElement?)elementComparer.Snapshot(e));
